...
SparkPreset preset24{0x0,0x7f,"07079063-94A9-41B1-AB1D-02CBC5D00790","Silver Ship","0.7","1-Clean","icon.png",120.000000,{ 
  {"bias.noisegate", false, 3, {0.138313, 0.224643, 0.000000}}, 
  {"LA2AComp", false, 3, {0.000000, 0.852394, 0.373072}}, 
  {"Booster", false, 1, {0.722592}}, 
  {"RolandJC120", true, 5, {0.632231, 0.081820, 0.558359, 0.671320, 0.805785}}, 
...
char spark_drives_extra[][STR_LEN + 1]{ "Booster", "DistortionTS9", "Overdrive", "Fuzz", "ProCoRat", "BassBigMuff",
                     "GuitarMuff", "MaestroBassmaster", "SABdriver", "TrebleBooster", "MetalZoneMT2" };

char spark_modulations_extra[][STR_LEN + 1]{ "Tremolo", "ChorusAnalog", "Flanger", "Phaser", "Vibrato01", "UniVibe",
                     "Cloner", "MiniVibe",  "Tremolator", "TremoloSquare", "Leslie01", "MuTron"};

char spark_amps_extra[][STR_LEN + 1]{ "RolandJC120", "Twin", "ADClean", "94MatchDCV2", "Bassman", "AC Boost", "Checkmate",
                     "TwoStoneSP50", "Deluxe65", "Plexi", "OverDrivenJM45", "OverDrivenLuxVerb",
                     "Bogner", "OrangeAD30","AmericanHighGain", "SLO100", "YJM100", "Rectifier",
                     "EVH", "SwitchAxeLead", "Invader", "BE101", "Acoustic", "AcousticAmpV2", "FatAcousticV2",
                     "FlatAcoustic", "GK800", "Sunny3000", "W600", "Hammer500", "JCM800",

                    "Deluxe57", "JCM900", "MatchlessDC30", "DrZ", "ENGL", "Hiwatt103", "SVT", "PowerAmp",
